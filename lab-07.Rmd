...
This is the misleading graph. The left y-axis labeled "Mask" ranges from 15 to 25. The right y-axis labeled "No Mask" ranges from 4 to 14. This makes the graph uninterpretable, though visually they look more alike than different. 
```{r}
